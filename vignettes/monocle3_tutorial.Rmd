...
First, we carry out differential expression testing "by hand". We fit a negative binomial GLMs of each test set gene onto the pseudotime computed from the training set. For computational efficiency, we only do this for 500 randomly selected genes. 
