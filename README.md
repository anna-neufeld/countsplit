...
Please see the [double dipping demonstration](https://anna-neufeld.github.io/countsplit/articles/demonstrating_problem.html) for the code that goes with Appendix A of our paper. 
