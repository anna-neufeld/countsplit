...
RcppExport SEXP _countsplit_LogNorm(SEXP dataSEXP, SEXP scale_factorSEXP, SEXP eps_trainSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< double >::type eps_train(eps_trainSEXP);
    rcpp_result_gen = Rcpp::wrap(LogNorm(data, scale_factor, eps_train));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_countsplit_LogNorm", (DL_FUNC) &_countsplit_LogNorm, 3},
    {NULL, NULL, 0}
};
