...
The plot below shows that the cells cluster nicely by their cell type in reduced dimensions. 
...
Finally, we learn the graph that will be usef to construct pseudotime. 
...
Now that we have estimated pseudotime using the training set, we are ready to study differential expression along pseudotime. 
